        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit Flavour</h5>
                        ...
                        @endif
                            <!-- Horizontal Form -->
                            <form method="POST" action="{{ url('admin/updateflavour') }}">
                                @csrf
                                <input type="hidden" class="form-control" id="inputText" name="id"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="inputText" name="flavour_name" value="{{ $flavourid->flavour_name }}">
                                        </div>
                                        @error('name')
