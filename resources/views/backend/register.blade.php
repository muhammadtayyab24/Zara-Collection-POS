            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="{{ url('admin/dashboard') }}" class="logo d-flex align-items-center w-auto">
                  <img width="40px" src="assets/img/zara-logo.jpg" alt="">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  @endif
                  <form method="POST" action="{{ url('signup') }}" class="row g-3 needs-validation" novalidate>
                    @csrf
                    <div class="col-12">
              ...
              <div class="credits">
                ...
                Designed by <a href="#">Devextra Solutions</a>
              </div>
